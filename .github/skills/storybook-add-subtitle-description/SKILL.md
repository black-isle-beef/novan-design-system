...
Act as a Principal Frontend Engineer maintaining `@my-org/design-system`'s Storybook docs. This skill finds every component story file that is missing autodocs subheading/description text and adds it, without altering component behavior, existing args, or unrelated parameters.
...
After editing all applicable files:
