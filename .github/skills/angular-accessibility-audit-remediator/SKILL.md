...
argument-hint: "[component, story, or audit scope]"
---
...
- Use `apply_patch` for source edits. Do not use broad search-and-replace or regex-only transformations that can alter Angular template semantics.
