...
This skill uses its bundled audit script at `.claude/skills/angular-scss-compliance-remediator/audit.ps1`. Run it before attempting remediation; do not replace it with an improvised audit or claim audit results.
